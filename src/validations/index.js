...
function applyChangePasswordValidations() {
    return [
        body("oldPasswd")
            .trim()
            .notEmpty()
        ...
        body("newPasswd")
            ...
            .withMessage(
                "New password must be at least 8 characters long and include at least one lowercase letter, one uppercase letter, one number, and one symbol"
            )
    ];
}

function applyForgotPasswordValidations() {
    return [
        body("email")
            .trim()
            .notEmpty()
...
function applyResetPasswordValidations() {
    return [
        body("newPasswd")
            .trim()
            .notEmpty()
